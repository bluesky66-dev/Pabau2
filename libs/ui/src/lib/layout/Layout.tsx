    ...
    <div>
      ...
      <Content style={{
        ...
        <Content style={{
          ...
          <Button type="primary" style={{float: 'right'}} onClick={onNewClick}>{newButtonText}</Button>}
          {children}
        </Content>
      ...
      <Content style={{
        ...
        <ul>
          <li><a>Setting up a Marketing Source</a></li>
        </ul>
        <div style={{
          position: "absolute",
          top: "-2em",
      ...
      <Footer>
        ...
        <div style={{display: 'flex', margin: '0 0', textTransform: 'uppercase'}}>
          <div>
            <Button type="default" danger>Delete</Button>

          </div>
          <div style={{textAlign: 'right', flex: 1, textTransform: 'uppercase'}}>
            <label style={{userSelect: 'none', cursor: 'pointer'}}>Active <Switch onChange={(e) => setIsActive(e)}
                                                                                  size="small" defaultChecked
                                                                                  style={{margin: '0 .5em'}}
                                                                                  title="yo"/></label>
            <Button type="default" style={{margin: '0 .5em'}} onClick={onCancelClick}>Cancel</Button>
            <Button type="primary" disabled={isActive} style={{margin: '0 .5em'}}>Save</Button>
          </div>
        </div>
