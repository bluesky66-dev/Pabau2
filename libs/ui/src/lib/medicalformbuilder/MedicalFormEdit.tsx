...
const medicalForms = [
  ...
  { id: 11, formType: 'basic', formName: 'basic_traveldestination' },
  { id: 12, formType: 'basic', formName: 'basic_vaccinescheduler' },
  { id: 13, formType: 'basic', formName: 'basic_vaccinehistory' },
  { id: 14, formType: 'basic', formName: 'basic_labtests' },
