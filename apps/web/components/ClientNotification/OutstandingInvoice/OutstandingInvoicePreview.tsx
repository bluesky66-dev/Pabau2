...
const langData: LangData = {
  ...
  bg: {
    ...
    bestRegards: 'С Най-Добри Пожелания,',
    senderFirstName: 'Рина',
  ...
  lv: {
    ...
    bestRegards: 'Geriausi linkėjimai,',
    senderFirstName: 'Rina',
      ...
      {standardTapIndex === '1' ? (
        ...
        >
          <Invoices
            ...
            bestRegards={selectLangData.bestRegards}
            footerText={
