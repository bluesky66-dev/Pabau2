...
import styles from '../../pages/pabau-care/style.module.less'
...
interface p {
  setIndexTab: number
  handleSendEmail?(val: string): void
  title: string
  ...
  return (
    <>
      ...
      <div>
        ...
        >
          <Button
            className={styles.pabauCareSendButton}
          ...
          <Button
            className={styles.pabauCareSaveButton}
            style={{
              margin: '1em 8px',
              height: '40px',
              fontSize: '14px',
            ...
            onClick={() =>
              Notification(
                ...
                'Success! Pabau care Source Updated'
              )
            }
          >
            Save
