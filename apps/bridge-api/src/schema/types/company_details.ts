...
export const company_details = objectType({
...
export const company_detailsQuery = extendType({
  type: 'Query',
  definition(t) {
    t.crud.company_details();
    t.crud.company_details({ filtering: true, ordering: true });
  },
});

export const company_detailsMutation = extendType({
  type: 'Mutation',
  definition(t) {
    t.crud.createOnecompany_details();
    t.crud.updateOnecompany_details();
    t.crud.upsertOnecompany_details();
    t.crud.deleteOnecompany_details();

    t.crud.updateManycompany_details();
    t.crud.deleteManycompany_details();
  },
});
