...
export const company_subscription = objectType({
...
export const company_subscriptionQuery = extendType({
  type: 'Query',
  definition(t) {
    t.crud.company_subscription();
    t.crud.company_subscriptions({ filtering: true, ordering: true });
  },
});

export const company_subscriptionMutation = extendType({
  type: 'Mutation',
  definition(t) {
    t.crud.createOnecompany_subscription();
    t.crud.updateOnecompany_subscription();
    t.crud.upsertOnecompany_subscription();
    t.crud.deleteOnecompany_subscription();

    t.crud.updateManycompany_subscription();
    t.crud.deleteManycompany_subscription();
  },
});
