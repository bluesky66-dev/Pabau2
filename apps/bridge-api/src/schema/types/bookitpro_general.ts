...
export const bookitpro_general = objectType({
  name: 'bookitpro_general',
  definition(t) {
    t.model.id();
    t.model.occupier();
...
export const bookitpro_generalQuery = extendType({
  type: 'Query',
  definition(t) {
    t.crud.bookitpro_general();
    t.crud.bookitpro_generals({ filtering: true, ordering: true });
  },
});

export const bookitpro_generalMutation = extendType({
  type: 'Mutation',
  definition(t) {
    t.crud.createOnebookitpro_general();
    t.crud.updateOnebookitpro_general();
    t.crud.upsertOnebookitpro_general();
    t.crud.deleteOnebookitpro_general();

    t.crud.updateManybookitpro_general();
    t.crud.deleteManybookitpro_general();
  },
});
